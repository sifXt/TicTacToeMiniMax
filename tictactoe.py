...
class Board:
    ...
    def final_state(self,show=False):
        ...
        if self.squares[2][0] == self.squares[1][1] == self.squares[0][2] != 0:
            if show:
                colour = CIRCLE_COLOUR if self.squares[1][col] == 2 else CROSS_COLOUR
                iPos = (20, HEIGHT - 20)
                fPos = (WIDTH - 20, 20)
                pygame.draw.line(screen, colour, iPos, fPos, LINE_WIDTH)
            return self.squares[1][1]
...
class Game:
    ...
    def __init__(self):
        ...
        self.player = 2
        # 1 - cross    2 - circle
        #initialize with 2 for computer to start
        self.gamemode = 'ai'
        #pvp or ai
        self.running = True
        self.show_lines()
    ...
    def show_lines(self):
        ...
        pygame.draw.line(screen, LINE_COLOUR, (2*SQSIZE, 0), (2*SQSIZE, HEIGHT), LINE_WIDTH)

        #horizontal
        pygame.draw.line(screen, LINE_COLOUR, (0, SQSIZE), (WIDTH, SQSIZE), LINE_WIDTH)
        pygame.draw.line(screen, LINE_COLOUR, (0, 2*SQSIZE), (WIDTH, 2*SQSIZE), LINE_WIDTH)
    ...
    def change_gamemode(self):
        if self.gamemode == 'pvp':
            self.gamemode = 'ai'
            print('Gamemode changed to AI')

        else:
            self.gamemode = 'pvp'
            print('Gamemode changed to PvP')
